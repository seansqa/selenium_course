...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS=" -ldl  -framework CoreFoundation $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS} -ldl  -framework CoreFoundation $SYSLIBS"
...
LIBPL=$(echo "$(prefix)/lib/python3.13/config-$(VERSION)$(ABIFLAGS)-darwin" | sed "s#$prefix#$prefix_real#")
SO=".cpython-313-darwin.so"
PYTHONFRAMEWORK=""
